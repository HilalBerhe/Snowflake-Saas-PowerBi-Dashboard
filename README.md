SnowFlake Power Bi.pdf
PDF
okay cna u write a github thing read me  are u able to include pictures from the pfd in the report here is the link to the github 
HilalBerhe/snowflake-saas-operating-model
SnowFlake Power Bi(1).pdf
PDF
can u rewrite this using the above their name is Snow flake power bi  part 1 to 3 with one space between eadch word and number excel stays the same 
Worked for 48s

Done. I rewrote the README using these exact filenames:

Snow Flake Power Bi Part 1.png
Snow Flake Power Bi Part 2.png
Snow Flake Power Bi Part 3.png

The Excel filename remains unchanged: SnowFlake Saas Operating Model.xlsx.

Download everything

Snowflake-GitHub-README-and-PNGs.zip

Individual files
README.md
Snow%20Flake%20Power%20Bi%20Part%201.png
Snow%20Flake%20Power%20Bi%20Part%202.png
Snow%20Flake%20Power%20Bi%20Part%203.png

Extract the ZIP and upload all four files to the repository together. Replace the existing README.md; the Power BI images will display automatically.

no still wrong and also one is not loading and only link those 3 pictures and the second one has no space betwene snow and flake its snowflake.. remove any pictures or png besides those and like everything stays the same mention the github link for the original saas workbook 
Worked for 42s

Fixed correctly now.

Only these three images are referenced:

Snow Flake Power Bi Part 1.png
Snowflake Power Bi Part 2.png — no space between Snow and Flake
Snow Flake Power Bi Part 3.png

All other PNG references were removed. The Excel content and filename stayed the same, and the original Snowflake SaaS workbook repository is linked.

Correct package

Download Snowflake-GitHub-CORRECTED.zip

Individual files
README.md
Snow%20Flake%20Power%20Bi%20Part%201.png
Snowflake%20Power%20Bi%20Part%202.png
Snow%20Flake%20Power%20Bi%20Part%203.png

Upload all four files to the repository’s main page and replace the existing README.md. Filename capitalization and spaces must remain exactly as shown.

also mention everything is in millions unless states outherw wise
Worked for 16s
...
Corrected ZIP package
README.md
sorry this is the excel model 
SnowFlake Saas Operating Model - Copy.xlsx
Worked for 1m 38s

Fixed. The README now links to the correct Excel model:

SnowFlake Saas Operating Model - Copy.xlsx

It still references only the three correct Power BI images and includes the USD-millions note.

README.md
Updated complete ZIP
